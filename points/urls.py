...
from points.views import Ping, Connect, GetPoints, GetItems, PurchaseItem, GetInventory, UpdatePoints
...
urlpatterns = [
    ...
    url('^updatePoints/(?P<userid>[0-9]+)/?$', UpdatePoints.as_view(), name='update_points'),
